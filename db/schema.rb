...
ActiveRecord::Schema[7.0].define(version: 2023_05_14_194552) do
  ...
  create_table "test_p_data", id: false, force: :cascade do |t|
    t.datetime "created_at", precision: nil
    t.string "sender", limit: 256
    t.text "message"
  end

  create_table "test_raw_data", id: false, force: :cascade do |t|
    t.text "row"
  end
